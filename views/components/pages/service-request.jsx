...
class RequestPage extends React.Component {
    ...
    render() {
        ...
        let formEmbed = <div>
            ...
            {selectedTier && <div className={`sb-form-group`}>
                    ...
                    <select className={`_input-`} onChange={this.changePlan}>
                        ...
                        {tier.references.payment_structure_templates.map(plan => {
                            return (<option key={plan.id}
                                            value={plan.id}>{`${plan.amount / 100} - ${plan.interval} - ${plan.type}`}</option>)
                        })}
                    </select>
                </div>
            }
        ...
        return <div className="app-content __request-for-user">
            <Content>
