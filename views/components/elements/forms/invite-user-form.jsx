...
let InviteUser = function(props){
    return <form onSubmit={props.handleSubmit}>
        <Field name={"email"} validate={[required(), email()]} component={inputField} type={"text"} label="Email"/>
        <Field name={"name"} validate={[required()]} component={inputField} type={"text"} label="Name"/>
