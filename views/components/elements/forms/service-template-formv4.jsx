                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <div style={sectionDescriptionStyle}>
                                    <SVGIcons id="basic-info-svg" width="40px" height="40px" fillColor={_.get(options, 'service_template_icon_fill_color.value', '#ffffff')}>
                        ...
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <div style={sectionDescriptionStyle}>
                                            <SVGIcons id="custom-field-svg" width="40px" height="40px" fillColor={_.get(options, 'service_template_icon_fill_color.value', '#ffffff')}>
