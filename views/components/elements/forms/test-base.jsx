...
//
//
// let TestBase = function(props){
//
//     // constructor(props) {
//     //
//     //     super(props);
//     //     console.log("IM DED", props);
//     //
//     // }
//
//
...
//             {/*Tabs*/}
//             {/*<pre >*/}
//             {/*{JSON.stringify(props.formJSONz, null, 2)}*/}
//             {/*</pre>*/}
//             {/*</div>*/}
//             <div className="row">
...
//         form={TestBase}
//         initialRequests={[{'method': 'GET', 'url': `/api/v1/service-categories`, 'name': '_categories'}]}
//
//     />)
// }
...
//     return (value || value !== '' || value !== null || value !== undefined) ? undefined : 'Required';
// }
const maxLength = max => value =>
    value && value.length > max ? `Must be ${max} characters or less` : undefined;
// const maxLength15 = maxLength(15);
...
const FieldLevelValidationForm = function(props){
