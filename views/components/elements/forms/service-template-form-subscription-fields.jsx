            ...
            if (serviceType == '_SUBSCRIPTION') {
                return (
                    <div className="service-fields">
                        ...
                        <div className="sb-form-group">
                            ...
                            <div className="row">
                                <input className="_input-" type="hidden" name="type" value={defaultData.subscription.type}/>
                                <div className="col-md-4">
                                    <input className="_input-" type="number" name="interval_count" value={defaultData.subscription.interval_count } onChange={this.handleChange}/>
                                </div>
                                <div className="col-md-8">
                                    <select className="_input-" type="select" name="interval" value={defaultData.subscription.interval} onChange={this.handleChange}>
                ...
                return (
                    <div className="service-fields">
                        <div className="sb-form-group">
                            ...
                            <input className="_input-" type="hidden" name="type" value={defaultData.one_time.type}/>
                        ...
                        <div className="sb-form-group">
                            <input disabled className="_input-" type="hidden" name="interval" value={defaultData.one_time.interval}/>
                        </div>
                        <div className="sb-form-group">
                            <input disabled className="_input-" type="hidden" name="interval_count" value={defaultData.one_time.interval_count}/>
                        </div>
                        <div className="sb-form-group">
                            <input disabled className="_input-" type="hidden" name="subscription_prorate" value={defaultData.one_time.subscription_prorate}/>
                        </div>
                    </div>
                );
            } else if (serviceType == '_CUSTOM') {
                return (
                    <div className="service-fields">
                        ...
                        <div className="sb-form-group">
                            <input className="_input-" type="hidden" name="type" value={defaultData.custom.type}/>
                            <input disabled className="_input-" type="hidden" name="amount" value={defaultData.custom.amount}/>
                        </div>
                        <div className="sb-form-group">
                            <input disabled className="_input-" type="hidden" name="interval" value={defaultData.custom.interval}/>
                        </div>
                        <div className="sb-form-group">
                            <input disabled className="_input-" type="hidden" name="subscription_prorate" value={defaultData.custom.subscription_prorate}/>
                        </div>
                    </div>
                );
            }
        ...
        return(
            <div>
                <div className="sb-form-group">
                    ...
                    <select disabled={this.props.formAction == '_EDIT'} className="_input-" type="select" name="service_type" value={this.state.serviceType} onChange={this.onToggleSubscription}>
