                ...
                <div className="service-instance-box-content p-b-30">
                    ...
                    <div className="row">
                        {this.props.instanceProperties.map( field => {
                            if(field.data) {
                                return (<div className="sb-form-groupform-group-flex"><ServiceInstanceField key={"item-" + field.id} currency={(this.props.instance.payment_plan && this.props.instance.payment_plan.currency) || "USD"} field={field}/></div>)
                            }
