...
default_notifications.templates = [
    {
        ...
        description: "Triggered when a service cancellation has been requested by a user",
    ...
    },
    {
        ...
        description: "Triggered when a service has been updated",
        model: "service-instance",
        send_email: true
    },
    {
        ...
        description: "Triggered when a service cancellation request has been approved",
    ...
    },
    {
        ...
        description: "Triggered when a service cancellation request has been rejected",
        model: "service-instance-cancellation",
        send_email: true
    },
    {
    ...
    },
    {
        ...
        subject: "New User",
        description: "Triggered for an admin when a new user has signed up",
        model: "user",
        send_email: true,
        send_to_owner: false
    },
    {
        ...
        description: "Triggered when an account has been suspended",
        model: "user",
        send_email: true
    },
    {
