...
default_notifications.templates = [
    ...
    {name:"request_service_instance_user",
        ...
        message:"Your service request for [[name]] has been completed. Please login to your account to view and access your <a href='[[_hostname]]/service-instance/[[id]]'>service</a>.",
    ...
    {name:"service_requires_payment_approval",
        ...
        message:"There are additional charges added to your service, [[name]]. Please login to your account and approve the <a href='[[_hostname]]/my-services'>charges</a>.",
    ...
    {name:"service_instance_update",
        ...
        message:"Your Service Instance [[name]] has been updated. You can use this link to view your <a href='[[_hostname]]/service-instance/[[id]]'>instance details</a>.",
    ...
    {name:"instance_cancellation_rejected",
        ...
        message:"Your cancellation request for has been rejected. For more information, contact your service provider or comment on your <a href='[[_hostname]]/service-instance/[[service_instance_id]]'>service</a> and we will get back to you shortly.",
    ...
    {name:"user_suspension",
        ...
        message:"Your ServiceBot account has been suspended. Please contact your service provider and check the state of your <a href='[[_hostname]]/my-services'>account</a>.",
