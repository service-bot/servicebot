...
default_notifications.templates = [
    {name:"request_service_instance_admin",
        event_name:"request_service_instance_admin",
    ...
    {name:"request_service_instance_user",
        event_name:"request_service_instance_user",
    ...
    {name:"request_service_instance_new_user",
        event_name:"request_service_instance_new_user",
    ...
    {name:"service_requires_payment_approval",
        event_name:"service_requires_payment_approval",
    ...
    {name:"service_cancellation_submitted",
        event_name:"service_cancellation_submitted",
    ...
    {name:"service_instance_update",
        event_name:"service_instance_update",
    ...
    {name:"instance_cancellation_approved",
        event_name:"instance_cancellation_approved",
    ...
    {name:"instance_cancellation_rejected",
        event_name:"instance_cancellation_rejected",
